...
function saveDraft(){const data={};['responsable','email','negocio','categoria','whatsapp','municipio','colonia'].forEach(id=>data[id]=val(id));localStorage.setItem(DRAFT_KEY,JSON.stringify(data));}
